...
// EXTI_InitTypeDef EXTI_InitStructure;
  ...
  GPIO_PinAFConfig(GPIOA,GPIO_PinSource11,GPIO_AF_OTG1_FS) ; //DM(D-)  Digital Minus
  GPIO_PinAFConfig(GPIOA,GPIO_PinSource12,GPIO_AF_OTG1_FS) ; //DP(D+)  Digital Positive
  
  /* this for ID line debug */
  
  
  GPIO_InitStructure.GPIO_Pin =  GPIO_Pin_10;				//Check Device or Host	
