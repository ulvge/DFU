...
void Printf_Init(void)
{
  ...
  */
  ...
  printf("\r\n\n\n\r ARMJISHU.COM神舟王STM32F207ZGT开发板 %s printf configured......", EVAL_COM1_STR);
  printf("\n\r ############ WWW.ARMJISHU.COM! ############ ("__DATE__ " - " __TIME__ ")");

  printf("%s", STM32F20x_STR);

  printf(" WWW.ARMJISHU.COM use __STM32F2XX_STDPERIPH_VERSION %d.%d.%d",
