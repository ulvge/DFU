...
unsigned char xUSART2_putchar_n(unsigned char ch);
...
const uint8_t STM32F2xx_STR[] = {"\r\n"\
           "  _____ _______ __  __ ____ ___  _________  ___\r\n"\
           " / ____|__   __|  \\/  |___ \\__ \\|  ___\\__ \\/ _ \\\r\n"\
           "| (___    | |  | \\  / | __) | ) | |__   ) | | | |_  __\r\n"\
           " \\___ \\   | |  | |\\/| ||__ < / /|  __| / /| | | \\ \\/ /\r\n"\
           " ____) |  | |  | |  | |___) / /_| |   / /_| |_| |>  <\r\n"\
           "|_____/   |_|  |_|  |_|____/____|_|  /____|\\___//_/\\_\\神舟系列开发板\r\n"\
           "\r\n"};
  ...
  */
  ...
  STM_EVAL_COMInit(COM2, &USART_InitStructure);
	...
	/* Enable the USART5 Interrupt */
  	NVIC_InitStructure.NVIC_IRQChannel = USART3_IRQn;//开发板COM2,实际上是usart3
  	...
  	USART_Cmd(USART3, ENABLE);  //enable USART5
...
void xPrintfCom1_Init(void)
{
  ...
  */
  ...
  /* Output a message on Hyperterminal using printf function */
  //printf("\n\rUSART Printf Example: retarget the C library printf function to the USART\n\r");
  xprintf("\r\n\n\n\r WWW.ARMJISHU.COM 神舟王STM32F207ZGT %s xprintf configured....", EVAL_COM1_STR);
  xprintf("\n\r ############ WWW.ARMJISHU.COM! ############ ("__DATE__ " - " __TIME__ ")");
...
unsigned char xUSART2_putchar_n(unsigned char ch)
{
  if('\n' == ch)
  {
    xUSART2_putchar('\r'); /*发送一个字符函数*/   
  }

  return xUSART2_putchar(ch); /*发送一个字符函数*/ 
}
