...
//**********************   DFU *********************************
#define APP_SPECIFIC_CLASS                0xfe  //DFU
#define DEVICE_FIRMWARE_UPGRADE           0x01  //1
#define DFU_RUN_TIME                        0x01  //1
...
typedef enum {
  ...
  ENUM_SET_RELIGION,		//state  and language
  ENUM_DEV_CONFIGURED
} ENUM_State;  
...
typedef struct _DeviceProp
{
  ...
  USBH_RELDesc_TypeDef              RELIGION_Desc;
...
typedef struct _USBH_USR_PROP
{
  ...
  void (*DeviceAttached)(void);           /* USBH_USR_DeviceAttached */
  ...
  void (*ConfigurationDescAvailable)(USBH_CfgDesc_TypeDef *,	//USBH_USR_Configuration_DescAvailable
